...
$ini = parse_ini_file('test-dist.ini', true);
...
$inHowManyBandsDoYouPlay = R::getAll('SELECT name_of_musician, COUNT( distinct '.R::$writer->getIDField('band').') AS bands 
...
$selectbox = R::getAll('SELECT m.'.R::$writer->getIDField('musician').', m.name, b.'.R::$writer->getIDField('band').' AS SELECTED FROM '.$p.'musician as m
